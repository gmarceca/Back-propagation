"""NN for predicting refrigerator power for a given building"""
...
train_x, train_y, test_x, test_y = load_data_RN()
...
test_y_cal = test_y[sel[category],:].reshape(1, test_y.shape[1])
...
parameters = L_layer_model(train_x, train_y_cal, test_x, test_y_cal, layers_dims, category, sigma_init=0.6, learning_rate=0.1, num_iterations = 20000, print_cost=True)
